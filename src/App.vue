...
<v-app id="inspire">
  ...
  -->
    ...
    <v-toolbar color="light blue" dark fixed app>
      ...
      <v-toolbar-title class="headline">Study time counter <strong class="font-weight-thin caption">Alpha-Version v0.4 (updated on 2018.12.06)</strong></v-toolbar-title>
